!((t, e) => {
	...
	function _n(t) {
		...
		for (var i = t; (i = i.parentNode); ) {
			...
			if (
				...
				("absolute" !== o || ["relative", "absolute", "fixed"].indexOf(n.position) >= 0)
			)
				return i;
		}
	...
	var w = (() => {
			...
			return (e, o, i) => (o && t(e.prototype, o), i && t(e, i), e);
		})(),
		C = void 0;
				...
				w(t, [
					...
					},
					{
						...
						value: function (t) {
							if (this.bindings?.[t]) {
								for (
									var e = 0, o = arguments.length, i = Array(o > 1 ? o - 1 : 0), n = 1;
									o > n;
									n++
								)
									i[n - 1] = arguments[n];
			...
			return (
				w(t, [
						...
						value: function (t) {
							...
							if (
								...
								["element", "target"].forEach((t) => {
									...
									"undefined" !== typeof this[t].jquery
										? (this[t] = this[t][0])
										: "string" === typeof this[t] && (this[t] = document.querySelector(this[t]));
								}),
					...
					},
					{
						...
						value: function () {
							...
							if ("scroll-handle" === this.targetModifier) {
								...
								n && (s = 15);
								var a =
										t.height - parseFloat(i.borderTopWidth) - parseFloat(i.borderBottomWidth) - s,
									e = {
										width: 15,
								...
								408 > a &&
									this.target === document.body &&
									(f = -11e-5 * a ** 2 - 0.00727 * a + 22.58),
									this.target !== document.body && (e.height = Math.max(e.height, 24));
								var h = this.target.scrollTop / (o.scrollHeight - a);
								return (
									(e.top = h * (a - e.height - f) + t.top + parseFloat(i.borderTopWidth)),
									this.target === document.body && (e.height = Math.max(e.height, 24)),
									e
								);
							}
					...
					},
					{
						key: "destroy",
						value: function () {
							this.disable(), B.forEach((e, o) => (e === this ? void B.splice(o, 1) : void 0));
						},
					},
					{
						...
						value: function (t, e) {
							...
							var r = [];
							i.forEach((t) => {
								r.push(`${this.getClass("element-attached")}-${t}`),
									r.push(`${this.getClass("target-attached")}-${t}`);
							}),
								T(() => {
									"undefined" !== typeof this._addAttachClasses &&
										(c(this.element, this._addAttachClasses, r),
										this.options.addTargetClasses !== !1 &&
											c(this.target, this._addAttachClasses, r),
					...
					},
					{
						...
						value: function () {
							...
							if (this.enabled) {
								...
								var i = this.cache("element-bounds", () => r(this.element)),
									n = i.width,
									f = i.height;
								...
								var l = this.cache("target-bounds", () => this.getTargetBounds()),
									d = l,
								...
								(u = v(u, c)), (p = v(p, g));
								for (
									var m = l.left + p.left - u.left, b = l.top + p.top - u.top, w = 0;
									w < C.modules.length;
									++w
								) {
									var O = C.modules[w],
								...
								return (
									document.body.scrollWidth > window.innerWidth &&
										((A = this.cache("scrollbar-size", a)), (x.viewport.bottom -= A.height)),
									document.body.scrollHeight > window.innerHeight &&
										((A = this.cache("scrollbar-size", a)), (x.viewport.right -= A.width)),
									(-1 === ["", "static"].indexOf(document.body.style.position) ||
										-1 === ["", "static"].indexOf(document.body.parentElement.style.position)) &&
									...
									"undefined" !== typeof this.options.optimizations &&
										...
										!(() => {
											var e = this.cache("target-offsetparent", () => s(this.target)),
												o = this.cache("target-offsetparent-bounds", () => r(e)),
												i = getComputedStyle(e),
												n = o,
												a = {};
											if (
						...
						value: function (t) {
							if ("undefined" !== typeof this.element.parentNode) {
								...
								var l = { top: "", left: "", right: "", bottom: "" },
									d = (t, o) => {
										var i = "undefined" !== typeof this.options.optimizations,
											n = i ? this.options.optimizations.gpu : null;
										if (n !== !1) {
											var r = void 0,
												s = void 0;
								...
								if (
									((o.page.top || o.page.bottom) && (o.page.left || o.page.right)
										...
										: (o.viewport.top || o.viewport.bottom) && (o.viewport.left || o.viewport.right)
											...
											: o.offset?.top && o.offset.left
												? !(() => {
														l.position = "absolute";
														var i = this.cache("target-offsetparent", () => s(this.target));
														s(this.element) !== i &&
															T(() => {
	...
	C.modules.push({
		position: function (t) {
			...
			var s = this.cache("element-bounds", () => r(this.element)),
				a = s.height,
				h = s.width;
			...
			var d = this.cache("target-bounds", () => this.getTargetBounds()),
				u = d.height,
				p = d.width,
				...
				this.options.constraints.forEach((t) => {
					...
					("target" === d || "both" === d) &&
						...
						"together" === d &&
							(o < w[1] &&
								...
								("bottom" === y.top
									...
									: "top" === y.top &&
										((o += u), (v.top = "bottom"), (o -= a), (y.top = "bottom"))),
							o + a > w[3] &&
								"bottom" === v.top &&
								("top" === y.top
									? ((o -= u), (v.top = "top"), (o -= a), (y.top = "bottom"))
									: "bottom" === y.top && ((o -= u), (v.top = "top"), (o += a), (y.top = "top"))),
							"middle" === v.top &&
								(o + a > w[3] && "top" === y.top
									? ((o -= a), (y.top = "bottom"))
						...
						("target" === l || "both" === l) &&
							...
							i + h > w[2] && "right" === v.left && ((i -= p), (v.left = "left"))),
						"together" === l &&
							(i < w[0] && "left" === v.left
								? "right" === y.left
						...
						("element" === d || "both" === d) &&
							(o < w[1] && "bottom" === y.top && ((o += a), (y.top = "top")),
							o + a > w[3] && "top" === y.top && ((o -= a), (y.top = "bottom"))),
						("element" === l || "both" === l) &&
							(i < w[0] &&
								("right" === y.left
									? ((i += h), (y.left = "left"))
					...
					o < w[1] && (f.indexOf("top") >= 0 ? ((o = w[1]), C.push("top")) : O.push("top")),
						o + a > w[3] &&
							(f.indexOf("bottom") >= 0 ? ((o = w[3] - a), C.push("bottom")) : O.push("bottom")),
						i < w[0] && (f.indexOf("left") >= 0 ? ((i = w[0]), C.push("left")) : O.push("left")),
						i + h > w[2] &&
							(f.indexOf("right") >= 0 ? ((i = w[2] - h), C.push("right")) : O.push("right")),
						C.length &&
							!(() => {
								var t = void 0;
								(t =
									"undefined" !== typeof this.options.pinnedClass
						...
						O.length &&
							!(() => {
								var t = void 0;
								(t =
									"undefined" !== typeof this.options.outOfBoundsClass
										? this.options.outOfBoundsClass
						...
						(v.top !== n.top ||
							v.left !== n.left ||
							y.top !== this.attachment.top ||
							y.left !== this.attachment.left) &&
							this.updateAttachClasses(y, v);
				}),
				T(() => {
					this.options.addTargetClasses !== !1 && c(this.target, m, g), c(this.element, m, g);
				}),
				{ top: o, left: i }
			);
		},
	...
	C.modules.push({
		position: function (t) {
			var o = t.top,
				i = t.left,
				n = this.cache("element-bounds", () => r(this.element)),
				s = n.height,
				a = n.width,
			...
			return (
				...
				g.forEach((t) => {
					u.push(`${this.getClass("abutted")}-${t}`);
				}),
				d.length && p.push(this.getClass("abutted")),
				d.forEach((t) => {
					p.push(`${this.getClass("abutted")}-${t}`);
				}),
				T(() => {
					this.options.addTargetClasses !== !1 && c(this.target, p, u), c(this.element, p, u);
				}),
				!0
			);
		},
