	...
	+((_a) => {
		...
		var d = (a, b, c) => {
			...
			e = (() => {
				...
				return (b, c, d) => (c && a(b.prototype, c), d && a(b, d), b);
			})(),
			f = ((a) => {
				function b(a) {
					return {}.toString
				...
				function f(b) {
					var d = !1;
					return (
						a(this).one(k.TRANSITION_END, () => {
							d = !0;
						}),
						setTimeout(() => {
							d || k.triggerTransitionEnd(this);
						}, b),
						this
					);
				}
				...
				var h = !1,
					...
					k = {
						...
						getSelectorFromElement: (a) => {
							...
							return (
								b || ((b = a.getAttribute("href") || ""), (b = /^#[a-z]/i.test(b) ? b : null)), b
							);
						},
						reflow: (a) => {
							new Function("bs", "return bs")(a.offsetHeight);
						},
						triggerTransitionEnd: (b) => {
							a(b).trigger(h.end);
						},
						supportsTransitionEnd: () => Boolean(h),
						typeCheckConfig: (a, d, e) => {
							for (var f in e)
			...
			g =
				(((a) => {
					...
					return (
						...
						(a.fn[b].noConflict = () => ((a.fn[b] = j), o._jQueryInterface)),
						o
					);
				})(jQuery),
				((a) => {
				...
				((a) => {
							...
							return (
								e(
									...
									[
										...
										},
										{
											...
											value: function (b) {
												...
												if (!(b > this._items.length - 1 || b < 0)) {
													if (this._isSliding)
														return void a(this._element).one(q.SLID, () => this.to(b));
										...
										{
											key: "_getConfig",
											value: (c) => ((c = a.extend({}, n, c)), f.typeCheckConfig(b, c, o), c),
										},
										{
										...
										},
										{
											...
											value: function (b) {
												return (
													(this._items = a.makeArray(a(b).parent().find(s.ITEM))),
										...
										},
										{
											key: "_slide",
											value: function (b, c) {
												var e = a(this._element).find(s.ACTIVE_ITEM)[0],
												...
												if (!j.isDefaultPrevented() && e && g) {
													...
													f.supportsTransitionEnd() && a(this._element).hasClass(r.SLIDE)
														? (a(g).addClass(b),
															f.reflow(g),
															a(e).addClass(i),
															a(g).addClass(i),
															a(e)
																.one(f.TRANSITION_END, () => {
																	a(g).removeClass(i).removeClass(b),
																		a(g).addClass(r.ACTIVE),
																		a(e).removeClass(r.ACTIVE).removeClass(b).removeClass(i),
																		(this._isSliding = !1),
																		setTimeout(() => a(this._element).trigger(l), 0);
																})
																.emulateTransitionEnd(k))
									...
									[
										{
											...
											value: function (b) {
												return this.each(function () {
													...
													if (
														(c || ((c = new i(this, d)), a(this).data(g, c)), "number" === typeof b)
													)
														c.to(b);
					...
					return (
						...
						(a.fn[b].noConflict = () => ((a.fn[b] = j), t._jQueryInterface)),
						t
					);
				})(jQuery),
				((a) => {
										...
										},
										{
											...
											value: function () {
												if (!this._isTransitioning && !a(this._element).hasClass(o.IN)) {
													...
													if (
														(this._parent &&
															((c = a.makeArray(a(q.ACTIVES))), c.length || (c = null)),
														!(c && ((d = a(c).data(g)), d?._isTransitioning)))
													) {
														...
														if ((a(this._element).trigger(e), !e.isDefaultPrevented())) {
															...
															var j = () => {
																a(this._element)
																	...
																	a(this._element).trigger(n.SHOWN);
															};
											...
											value: function () {
												...
												return (
													a(c)
														.find(d)
														.each((_a, c) => {
															this._addAriaAndCollapsedClass(h._getTargetFromElement(c), [c]);
														}),
													c
												);
											},
					...
					return (
						...
						(a.fn[b].noConflict = () => ((a.fn[b] = j), r._jQueryInterface)),
						r
					);
				})(jQuery),
				((a) => {
										...
										},
										{
											...
											value: function (c) {
												if (
													...
													if (((g = g.filter((a) => a.offsetWidth || a.offsetHeight)), g.length)) {
					...
					return (
						a(document)
							...
							.on(o.CLICK_DATA_API, q.FORM_CHILD, (a) => {
								a.stopPropagation();
							}),
						(a.fn[b] = r._jQueryInterface),
						(a.fn[b].Constructor = r),
				...
				((a) => {
								...
								e(
									...
									[
										...
										},
										{
											key: "show",
											value: function (b) {
												var d = a.Event(p.SHOW, { relatedTarget: b });
												a(this._element).trigger(d),
													this._isShown ||
														...
														a(this._dialog).on(p.MOUSEDOWN_DISMISS, () => {
															a(this._element).one(p.MOUSEUP_DISMISS, (b) => {
																a(b.target).is(this._element) && (this._ignoreBackdropClick = !0);
															});
														}),
										...
										},
										{
											key: "_showElement",
											value: function (b) {
												var d = f.supportsTransitionEnd() && a(this._element).hasClass(q.FADE);
												...
												a(document)
													...
													.on(p.FOCUSIN, (c) => {
														document === c.target ||
															...
															a(this._element).has(c.target).length ||
															this._element.focus();
													});
											},
										},
										{
											...
											value: function () {
												this._isShown && this._config.keyboard
													? a(this._element).on(p.KEYDOWN_DISMISS, (a) => {
															a.which === m && this.hide();
														})
												...
												(this._element.style.display = "none"),
													...
													this._showBackdrop(() => {
														a(document.body).removeClass(q.OPEN),
															...
															a(this._element).trigger(p.HIDDEN);
													});
											},
										},
										{
										...
										},
										{
											key: "_showBackdrop",
											value: function (b) {
												var d = a(this._element).hasClass(q.FADE) ? q.FADE : "";
												if (this._isShown && this._config.backdrop) {
													...
													if (
														...
														a(this._element).on(p.CLICK_DISMISS, (a) =>
									...
									[
										{
											...
											value: function (b, c) {
												return this.each(function () {
													...
													if (
														(d || ((d = new i(this, e)), a(this).data(g, d)), "string" === typeof b)
													) {
														if (void 0 === d[b]) throw new Error(`No method named "${b}"`);
														d[b](c);
					...
					return (
						...
						(a.fn[b].noConflict = () => ((a.fn[b] = j), s._jQueryInterface)),
						s
					);
				})(jQuery),
				((a) => {
									...
									[
										...
										},
										{
											...
											value: function (b) {
												...
												c = c.map((a) => `${a}[data-target="${b}"],${a}[href="${b}"]`);
												var d = a(c.join(","));
									...
									[
										{
											...
											value: function (b) {
												return this.each(function () {
													...
													if (
														(c || ((c = new i(this, d)), a(this).data(g, c)), "string" === typeof b)
													) {
					...
					return (
						...
						(a.fn[b].noConflict = () => ((a.fn[b] = j), q._jQueryInterface)),
						q
					);
				})(jQuery),
				((a) => {
											...
											value: function () {
												if (
													...
													if (
														...
														var j = () => {
															var c = a.Event(l.HIDDEN, { relatedTarget: this._element }),
																e = a.Event(l.SHOWN, { relatedTarget: d });
															a(d).trigger(c), a(this._element).trigger(e);
														};
											...
											value: function (b, c, d) {
												var e = a(c).find(n.ACTIVE_CHILD)[0],
													g =
														d &&
														f.supportsTransitionEnd() &&
														((e && a(e).hasClass(m.FADE)) || Boolean(a(c).find(n.FADE_CHILD)[0])),
										...
										},
										{
											...
											value: (b, c, d, e) => {
												...
												if (
													...
													d ? (f.reflow(b), a(b).addClass(m.IN)) : a(b).removeClass(m.FADE),
				...
				((a) => {
											...
											value: function () {
												...
												if (this.isWithContent() && this._isEnabled) {
													...
													a(e).data(this.constructor.DATA_KEY, this).appendTo(document.body),
														...
														a(e).addClass(q.IN);
													var l = () => {
														var c = this._hoverState;
														(this._hoverState = null),
															a(this.element).trigger(this.constructor.Event.SHOWN),
															c === o.OUT && this._leave(null, this);
													};
										...
										},
										{
											...
											value: function (b) {
												var d = this.getTipElement(),
													...
													g = () => {
														this._hoverState !== o.IN &&
															d.parentNode &&
															d.parentNode.removeChild(d),
															this.element.removeAttribute("aria-describedby"),
															a(this.element).trigger(this.constructor.Event.HIDDEN),
															this.cleanupTether(),
															b?.();
													};
												a(this.element).trigger(e),
													e.isDefaultPrevented() ||
														...
														f.supportsTransitionEnd() && a(this.tip).hasClass(q.FADE)
											...
											value: function () {
												...
												c.forEach((c) => {
													if ("click" === c)
														...
														a(this.element)
															.on(d, this.config.selector, a.proxy(this._enter, this))
															.on(e, this.config.selector, a.proxy(this._leave, this));
													}
												}),
													this.config.selector
										...
										},
										{
											...
											value: function (b, c) {
												...
												return (
													...
													a(c.getTipElement()).hasClass(q.IN) || c._hoverState === o.IN
					...
					return (
						...
						(a.fn[b].noConflict = () => ((a.fn[b] = i), u._jQueryInterface)),
						u
					);
				})(jQuery));
		((a) => {
							...
							[
								{
									...
									value: function (b) {
										return this.each(function () {
											...
											if (
												(c || !/destroy|hide/.test(b)) &&
												(c || ((c = new k(this, d)), a(this).data(i, c)), "string" === typeof b)
											) {
												if (void 0 === c[b]) throw new Error(`No method named "${b}"`);
												c[b]();
											}
			...
			return (
				...
				(a.fn[f].noConflict = () => ((a.fn[f] = k), q._jQueryInterface)),
				q
			);
		})(jQuery);
	})(jQuery);
