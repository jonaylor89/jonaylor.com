function _viewModel() {
	...
	this.sections = [
		...
		},
		{
			...
			subsections: [
				{
					header: ["New York City, NY", "Tapped Ai", "Spring 2023 - Present"],
					bullets: [
				...
				{
					header: ["Richmond, VA", "Afton Chemical", "Winter 2018 - Summer 2019"],
					bullets: [
				...
				{
					noPrint: true,
					header: ["Richmond, VA", "VCU Labs & Classrooms Computing", "Summer 2018 - Summer 2019"],
					bullets: [
				...
				{
					noPrint: true,
					header: ["Richmond, VA", "Research Assistant", "Fall 2018 - Spring 2019"],
					bullets: [
		...
		},
		{
			...
			subsections: [
				...
				{
					header: ["President of Student Advisory Board", "Summer 2020 - Present"],
					bullets: [
				...
				},
				{
					...
					bullets: ["Manage a student developer club including monthly workshops on Google Cloud"],
				},
				{
			...
			subsections: [
				{
					...
					header: ["AWS Certified Machine Learning - Specialty", "November 2021 - November 2024"],
				},
				{
					decorators: {
						url: "https://www.youracclaim.com/badges/a4587f99-1dd4-4481-b9d5-cf2c68d5cb59/public_url",
					},
					header: ["AWS Solutions Architect - Associate", "July 2020 - July 2023"],
				},
				{
					decorators: {
		...
		},
		{
			...
			subsections: [
				{
					header: ["Richmond, VA", "Master of Science", "Fall 2020 - Spring 2021"],
					bullets: [
						"Master of Computer Science degree from Virginia Commonwealth University (Data Science+Machine Learning)",
					],
				},
				{
					header: ["Richmond, VA", "Bachelor of Science", "Fall 2017 - Spring 2020"],
					bullets: ["Bachelor in Computer Science degree from Virginia Commonwealth University"],
				},
			],
		},
	];
