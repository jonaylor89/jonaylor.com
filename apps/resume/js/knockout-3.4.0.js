		...
		((n) => {
			...
			a.a = (() => {
				...
				var m = { propertychange: !0 },
					h =
						...
						(() => {
							for (
								var a = 3, b = u.createElement("div"), c = b.getElementsByTagName("i");
				...
				return {
					...
					ra: (a, b) => {
						if (Array.isArray(b)) a.push.apply(a, b);
					...
					jc: (b) => {
						b = a.a.V(b);
						for (
							var c = (b[0]?.ownerDocument || u).createElement("div"), d = 0, e = b.length;
							d < e;
							d++
						)
							c.appendChild(a.$(b[d]));
					...
					nb: (b) => a.a.Mc(b, b.ownerDocument.documentElement),
					Qb: (b) => !!a.a.Sb(b, a.a.nb),
					A: (a) => a?.tagName?.toLowerCase(),
					Wb: (b) =>
						a.onError
							? function () {
									try {
							...
							: b,
					setTimeout: (b, c) => setTimeout(a.a.Wb(b), c),
					$b: (b) => {
						setTimeout(() => {
							a.onError?.(b);
							throw b;
					...
					Rc: (a) => {
						9 <= h &&
							((a = 1 === a.nodeType ? a : a.parentNode), a.style && (a.style.zoom = a.style.zoom));
					},
					Nc: (a) => {
						if (h) {
							var b = a.style.width;
					...
					ec: (b, c) => {
						for (
							var d = a.a
								...
								e = "string" === typeof c ? (a) => a.name === c : (a) => c.test(a.name),
								h = [],
								m = d.length - 1;
							0 <= m;
							m--
			...
			a.M = (() => {
				...
				return {
					...
					lc: (a) => ((a = a.match(/^\[ko_memo:(.*?)\]$/)) ? a[1] : null),
				};
			})();
			a.b("memoization", a.M);
			...
			var I = "change",
				D = {
					...
					X: function (b, c, d) {
						d = d || I;
						var f = new a.vc(this, c ? b.bind(c) : b, () => {
							a.a.La(this.K[d], f);
							this.Ia?.(d);
						});
						this.sa?.(d);
					...
					Ta: function (b) {
						var d = a.H(this),
							...
							f,
							g;
						this.Ha || ((this.Ha = this.notifySubscribers), (this.notifySubscribers = W));
						var k = b(() => {
							this.Mb = !1;
							d && g === this && (g = this());
							e = !1;
							this.tb(f, g) && this.Ha((f = g));
						});
						this.Lb = (a) => {
							this.Mb = e = !0;
							g = a;
			...
			a.J.fn = D;
			a.hc = (a) =>
				null != a && "function" === typeof a.X && "function" === typeof a.notifySubscribers;
			...
			B[H] = a.N;
			a.Oa = (b, c) => (null === b || b === n || b[H] === n ? !1 : b[H] === c ? !0 : a.Oa(b[H], c));
			a.H = (b) => a.Oa(b, a.N);
			a.Ba = (b) =>
				("function" === typeof b && b[H] === a.N) ||
			...
			a.la.fn = {
				remove: function (b) {
					for (
						var c = this.t(),
							d = [],
							e = "function" !== typeof b || a.H(b) ? (a) => a === b : b,
							f = 0;
						f < c.length;
						f++
					) {
				...
				removeAll: function (b) {
					...
					return b ? this.remove((c) => 0 <= a.a.o(b, c)) : [];
				},
				destroy: function (b) {
					var c = this.t(),
						d = "function" !== typeof b || a.H(b) ? (a) => a === b : b;
					this.ga();
					for (var e = c.length - 1; 0 <= e; e--) d(c[e]) && (c[e]._destroy = !0);
					this.fa();
				},
				destroyAll: function (b) {
					return b === n ? this.destroy(() => !0) : b ? this.destroy((c) => 0 <= a.a.o(b, c)) : [];
				},
				indexOf: function (b) {
					var c = this();
					return a.a.o(c, b);
			...
			a.a.q("pop push reverse shift sort splice unshift".split(" "), (b) => {
				a.la.fn[b] = function () {
					var a = this.t();
					this.ga();
			...
			a.ya.trackArrayChanges = (b, c) => {
				function d() {
					if (!e) {
						e = !0;
						var c = b.notifySubscribers;
						b.notifySubscribers = function (_a, b) {
							(b && b !== I) || ++k;
						...
						_g = b.X((c) => {
							...
							f = null;
							k = 0;
							e?.length && b.notifySubscribers(e, "arrayChange");
						});
					}
				}
				b.hb = {};
			...
			var z = {
					...
					ac: function () {
						var c = this.throttleEvaluation;
						c && 0 <= c
							? (clearTimeout(this[s].bc),
								(this[s].bc = a.a.setTimeout(() => {
									this.aa(!0);
								}, c)))
							: this.Fa
								? this.Fa()
				...
				$ = {
					sa: function (b) {
						...
						if (!d.R && d.s && "change" === b) {
							d.s = !1;
							if (d.S || this.Qa()) (d.r = null), (d.L = 0), (d.S = !0), this.aa();
							else {
								var e = [];
								a.a.D(d.r, (a, b) => {
									e[b.Ga] = a;
							...
							d.R || this.notifySubscribers(d.T, "awake");
						}
					},
					Ia: function (b) {
						var c = this[s];
					...
					if (d) {
						...
						for (var A = 0, y; (y = d[A]); ++A) {
							...
							if (44 === t) {
								if (0 >= p) {
									c.push(
										r && k.length ? { key: r, value: k.join("") } : { unknown: r || k.join("") }
									);
									r = p = 0;
									k = [];
									continue;
								...
								47 === t && A && 1 < y.length
									...
									: 40 === t || 123 === t || 91 === t
										...
										: 41 === t || 125 === t || 93 === t
											? --p
											: r || k.length || (34 !== t && 39 !== t) || (y = y.slice(1, -1));
							k.push(y);
						}
					}
					return c;
					...
					Ua: (e, m) => {
						function h(b, e) {
							...
							if (!A) {
								...
								if (l?.preprocess && !(e = l.preprocess(e, b, h))) return;
								if ((l = k[b]))
									(m = e),
										0 <= a.a.o(c, m)
											? (m = !1)
			...
			(() => {
				...
				a.f = {
					Z: {},
					childNodes: (a) => (b(a) ? d(a) : a.childNodes),
					xa: (c) => {
						if (b(c)) {
							c = a.f.childNodes(c);
					...
					firstChild: (a) =>
						b(a) ? (!a.nextSibling || c(a.nextSibling) ? null : a.nextSibling) : a.firstChild,
					nextSibling: (a) => {
						b(a) && (a = e(a));
						return a.nextSibling && c(a.nextSibling) ? null : a.nextSibling;
					},
					Tc: b,
					pd: (a) => ((a = (f ? a.text : a.nodeValue).match(g)) ? a[1] : null),
					kc: (d) => {
						if (l[a.a.A(d)]) {
							var h = d.firstChild;
							if (h) {
			...
			(() => {
				...
				a.a.extend(a.Q.prototype, {
					...
					getBindings: function (b, c) {
						var _d = this.getBindingsString(b, c),
					...
					parseBindingsString: function (b, c, d, e) {
						try {
							...
							throw (
								((h.message = `Unable to parse bindings.\nBindings value: ${b}\nMessage: ${h.message}`),
								h)
							);
						}
					},
			...
			(() => {
				...
				function d(b) {
					return a.a.Ca(a.l.w(b), (_a, c) => () => b()[c]);
				}
				function e(c, e, h) {
							...
							try {
								"function" === typeof d &&
									a.l.w(() => {
										...
										if (a?.controlsDescendantBindings) {
											if (u !== n)
												throw Error(
													"Multiple bindings (" +
														u +
								...
								throw (
									((m.message = `Unable to process binding "${f}: ${g[f]}"\nMessage: ${m.message}`),
									m)
								);
							}
						});
				...
				a.getBindingHandler = (b) => a.d[b];
				a.U = function (b, c, d, e) {
					var f = "function" === typeof b && !a.H(b),
						m,
						g = a.B(
							() => {
								var m = f ? b() : b,
									l = a.a.c(m);
								c
									? (c.P?.(), a.a.extend(this, c), g && (this.P = g))
									: ((this.$parents = []), (this.$root = l), (this.ko = a));
								this.$rawData = m;
								this.$data = l;
								d && (this[d] = l);
								e?.(this, c, l);
					...
					g.ba() &&
						...
						(g.Ac = (b) => {
							...
							a.a.F.oa(b, (b) => {
								a.a.La(m, b);
								m.length || (g.k(), (this.P = g = n));
							});
						}));
				};
				a.U.prototype.createChildContext = function (b, c, d) {
					return new a.U(b, this, c, (a, b) => {
						a.$parentContext = b;
						a.$parent = b.$data;
				...
				a.U.prototype.extend = function (b) {
					return new a.U(this.P || this.$data, this, null, (c, d) => {
						c.$rawData = d.$rawData;
				...
				var q = a.a.e.I(),
					p = a.a.e.I();
				a.tc = function (b, c) {
					if (2 === arguments.length) a.a.e.set(b, p, c), c.P?.Ac(b);
			...
			(() => {
				...
				function c(a, b, d) {
					if ("function" === typeof b) d((a) => new b(a));
				...
				a.g.Zb = {
					...
					loadTemplate: (b, c, f) => {
						...
						if ("string" === typeof c) f(a.a.ma(c));
							...
							if (
								((c = c.element),
								x.HTMLElement ? c instanceof HTMLElement : c?.tagName && 1 === c.nodeType)
							)
								f(d(c));
			...
			(() => {
				a.d.checked = {
					...
					init: (b, c, d) => {
						...
						if (k || l) {
							var m = c(),
								h = k && Array.isArray(a.a.c(m)),
								r = !(h && m.push && m.splice),
								q = h ? g() : n,
								p = l || h;
							l && !b.name && a.d.uniqueName.init(b, () => !0);
							a.m(e, null, { i: b });
							a.a.p(b, "click", e);
							a.m(f, null, { i: b });
							m = n;
						...
						"string" === typeof g &&
							a.a.p(b, g, function (b) {
								...
								if (h) {
									...
									!1 === d.get(`${g}Bubble`) && ((b.cancelBubble = !0), b.stopPropagation?.());
								}
							});
					});
				},
			...
			a.d.foreach = {
				...
				init: (b, c) => a.d.template.init(b, a.d.foreach.ic(c)),
				update: (b, c, d, e, f) => a.d.template.update(b, a.d.foreach.ic(c), d, e, f),
			};
			a.h.ta.foreach = !1;
			a.f.Z.foreach = !0;
			a.d.hasfocus = {
			...
			a.h.ea.hasFocus = !0;
			a.d.html = {
				init: () => ({ controlsDescendantBindings: !0 }),
				update: (b, c) => {
					a.a.Cb(b, c());
				},
			};
			K("if");
			K("ifnot", !1, !0);
			K("with", !0, !1, (a, c) => a.createChildContext(c));
			var L = {};
			a.d.options = {
				init: (b) => {
				...
				update: (b, c, d) => {
					function e() {
						return a.a.Ka(b.options, (a) => a.selected);
					}
					function f(a, b, c) {
						var d = typeof b;
					...
					m &&
						...
						(q = a.a.Ka(m, (b) => r || b === n || null === b || !a.a.c(b._destroy))),
			...
			a.d.selectedOptions = {
				...
				init: (b, c, d) => {
					a.a.p(b, "change", () => {
						var e = c(),
							f = [];
						a.a.q(b.getElementsByTagName("option"), (b) => {
			...
			(() => {
				if (x?.navigator)
					var b = (a) => {
						...
						c = x.opera?.version && parseInt(x.opera.version(), 10),
						...
						10 > a.a.C
							...
							: (l("input", t),
								5 > e && "textarea" === a.a.A(b)
									...
									: 11 > c
										? l("keydown", y)
										: 4 > f && (l("DOMAutoComplete", t), l("dragdrop", t), l("drop", t)));
						l("change", t);
						a.m(k, null, { i: b });
					},
				};
			...
			a.O.prototype.createJavaScriptEvaluatorBlock = () => {
				throw Error("Override createJavaScriptEvaluatorBlock");
			};
			a.O.prototype.makeTemplateSource = (b, c) => {
				if ("string" === typeof b) {
					c = c || u;
			...
			a.Gb = (() => {
				...
				return {
					Oc: (b, c, d) => {
						c.isTemplateRewritten(b, d) || c.rewriteTemplate(b, (b) => a.Gb.dd(b, c), d);
					},
					dd: (a, f) =>
						a
							.replace(c, (_a, c, d, _e, h) => b(h, c, d, f))
							.replace(d, (_a, c) => b(c, "\x3c!-- ko --\x3e", "#comment", f)),
					Ec: (b, c) =>
						a.M.wb((d, k) => {
							var l = d.nextSibling;
			...
			(() => {
				...
				a.kd = (b, d, g, k, q) => {
					...
					function u(a, c) {
						s = q.createChildContext(a, g.as, (a) => {
							a.$index = c;
						});
						var d = f(b, a, s);
					...
					return a.B(
						() => {
							...
							b = a.a.Ka(
								b,
								(b) => g.includeDestroyed || b === n || null === b || !a.a.c(b._destroy)
							);
			...
			a.a.ib = (() => {
				function b(b, d, e, f, g) {
					...
					for (q = p; h || q; )
						(p = m[h][q] - 1),
							q && p === m[h][q - 1]
								? l.push((k[k.length] = { status: e, value: d[--q], index: q }))
								: h && p === m[h - 1][q]
									? s.push((k[k.length] = { status: f, value: b[--h], index: h }))
					...
					for (var D = [], p = [], w, C = 0, B, E; (B = s[C]); C++)
						switch (((E = B.moved), B.status)) {
							case "deleted":
								E === n &&
									...
									a.a.za(w.ca, e).length &&
										(k.beforeRemove && (u.push(w), z.push(w), w.ja === d ? (w = null) : (f[C] = w)),
							...
							case "added":
								E !== n
									? m(C, E)
									: ((w = { ja: B.value, qb: a.N(v++) }), u.push(w), z.push(w), r || (p[C] = w));
						}
					a.a.e.set(e, c, u);
					h(k.beforeMove, D);
			...
			a.W.prototype.renderTemplateSource = (b, c, _d, e) => {
			...
			(() => {
				a.vb = function () {
					...
					this.renderTemplateSource = (b, e, f, g) => {
						g = g || u;
						f = f || {};
						if (2 > a)
							throw Error(
					...
					this.createJavaScriptEvaluatorBlock = (a) =>
						`{{ko_code ((function() { return ${a} })()) }}`;
					this.addTemplate = (a, b) => {
