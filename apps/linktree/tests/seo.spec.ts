...
test("Plausible Analytics script is loaded", async ({ page }) => {
	...
	await expect(plausibleScript).toHaveAttribute("data-domain", "linktree.jonaylor.com");
	await expect(plausibleScript).toHaveAttribute("src", "https://plausible.io/js/script.js");
});
