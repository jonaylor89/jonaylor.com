import { ImageMagick, initialize } from "https://deno.land/x/imagemagick_deno@0.0.31/mod.ts";
...
async function optimizeImages() {
	...
	try {
		...
		console.error(
			`❌ Directory ${IMAGES_DIR} not found. Make sure you've moved images to src/assets/images first.`
		);
		Deno.exit(1);
	}
