...
date: "2025-11-17"
subtitle: "Why most algorithmic trading backtests are theater / not all crashes are the same / how to do better"
tags: [trading, ai, risk, monte-carlo, mandelbrot, jupyter, manim, fat-tails]
coverImage: "../../assets/images/covers/algo-backtests-are-lying-to-you.jpg"
...
![ChatGPT conversation](../../assets/images/posts/algo-backtests-are-lying-to-you-image-2.png)
...
![It only works for thin tails](../../assets/images/posts/algo-backtests-are-lying-to-you-image-3.png)
...
![Quantile-payoff chart highlighting unseen tail mass](../../assets/images/posts/algo-backtests-are-lying-to-you-image-4.png)
...
![Regime stress equity curve](../../assets/images/posts/algo-backtests-are-lying-to-you-image-7.png)
...
| --- | --- | --- | --- |
| SPY • Calm 2010-2019 | 105.0% | 0.65 | -22.0% |
| SPY • GFC 2007-2009 | 11.6% | 0.33 | -19.8% |
| SPY • Pandemic 2020 | 21.2% | 1.22 | -9.4% |
| BTC-USD • Rally 2020-2021 | 467.1% | 1.00 | -39.5% |
| BTC-USD • Crypto Winter 2021-2023 | 35.6% | 0.49 | -21.2% |
...
![Consequences of Fat Tails](../../assets/images/posts/algo-backtests-are-lying-to-you-image-1.png)
...
- [Fractal Market Hypothesis](https://www.investopedia.com/terms/f/fractal-markets-hypothesis-fmh.asp) and Mandelbrot's argument for [Lévy-stable markets](https://en.wikipedia.org/wiki/Benoit_Mandelbrot#Randomness_and_fractals_in_financial_markets).
...
1. Whale economics in revenue metrics: Most users give $0–$2, one gives $400. Ergo a single whale makes a mediocre arm look top-tier.
...
3. Safety violations with huge negative tails: Mostly safe outputs (reward 0) punctuated by rare –500 violations. Ergo long streaks of “all good” trick the bandit into thinking the arm is safe.
