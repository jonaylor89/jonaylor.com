---
title: "Introducing Saint John™️"
date: "2025-10-26"
subtitle: "The First Android Home Screen with a Built In LLM Agent"
tags: ["ai", "android", "launcher", "minimalism", "personal-software", "design", "kotlin", "indie-dev", "claude"]
coverImage: "../../assets/images/covers/introducing-saint-john-cover.png"
...
I switched to an iPhone for the first time in 2022 to do app development for [Audius](http://audius.co/) and later [Tapped Ai](https://tapped.ai/) and [Udio](https://udio.com/). Every since I’ve felt 10x more glued to my phone. Not necessarily in a “ios is better than android” kinda way but it seemed like the funnel or slope leading to my distractions was much more slippery on my iPhone. The past few months I’ve been on a campaign to filter many other distractions in my life so addressing this problem with iPhones was now priority.
...
![Saint John Screens.png](../../assets/images/posts/introducing-saint-john-image-1.png)
...
# EDIT: Saint John Suspended

Google Play decided to suspend Saint John from the play story because their stupid new AI reviewer kept rejecting it.

![Saint John Suspended](../../assets/images/posts/introducing-saint-john-image-2.jpg)
