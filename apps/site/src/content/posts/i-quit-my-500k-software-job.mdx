...
date: "2025-10-07"
subtitle: "Letting go of my $500k software job and building in the age of fast fashion software"
tags: ["self", "startup", "career", "personal", "reflection", "ai", "music"]
coverImage: "../../assets/images/covers/i-quit-my-software-job-cover.png"
coverImageAlt: "blog post cover image"
---

<Callout type="info">
  I empathize with everyone fucked by the Udio x UMG deal but I don't plan on releasing the udio source code or weights (which would unquestionably be a federal crime) so sending me DMs, emails, or commenting on my personal instagram won't get me to do so.
...
![Screenshot of Moments page](../../assets/images/posts/i-quit-my-software-job-1.png)
...
![Screenshot of sam altman tweet](../../assets/images/posts/i-quit-my-software-job-2.png)
